# Year 3 Computing — Tutor Scripts (Lessons 1–18)

Complete tutor scripts for [Year 3 Computing](../computing-year-3.md), built to the [scripting guide](../../../SCRIPTING-GUIDE.md) and grounded in `knowledge-base/subjects/computing-life-skills/computing-ks1-ks2.md` and `online-safety.md`. Year 3 is the year of **repetition** (loops), with branching databases, multimedia, source-evaluation and a warm online-safety unit. Unplugged-first wherever it helps. Every beat ⏱ sums to the duration, with verbatim Say / Show / Do / Ask, a real CHECK with wrong-answer fixes, the mandatory "if the child is stuck" protocol, differentiation, extension and assessment evidence. A Year 3 child (ages 8–9) gets longer practice and reasoning probes ("how do you know?"). Keep the online-safety unit **warm and reassuring** — never imply a child is to blame.
...
**Computing · Year 3 · Unit 1 (Loops & repetition)** | **Duration:** 30 min | **Objective:** "By the end, I can spot a repeating pattern and say how many times it repeats."
...
**Prior knowledge to retrieve:** Year 2 — programs are sequences of blocks that run in order.
...
**Computing · Year 3 · Unit 1 (Loops & repetition)** | **Duration:** 35 min | **Objective:** "By the end, I can use a 'repeat ( )' loop to replace many copied blocks."
...
**Computing · Year 3 · Unit 1 (Loops & repetition)** | **Duration:** 30 min | **Objective:** "By the end, I can choose 'repeat ( )' or 'forever' for the right job."
...
**Computing · Year 3 · Unit 1 (Loops & repetition)** | **Duration:** 35 min | **Objective:** "By the end, I can use a loop with the pen to draw a regular shape."
...
**Computing · Year 3 · Unit 1 (Loops & repetition)** | **Duration:** 30 min | **Objective:** "By the end, I can find and fix a bug in a loop program."
...
**Computing · Year 3 · Unit 2 (Branching databases)** | **Duration:** 30 min | **Objective:** "By the end, I can sort a set of things using a series of yes/no questions."
...
**Prior knowledge to retrieve:** Year 2 — sorting/organising information (charts, groups).
...
**Computing · Year 3 · Unit 2 (Branching databases)** | **Duration:** 35 min | **Objective:** "By the end, I can build a branching database that identifies items by yes/no questions."
...
**Computing · Year 3 · Unit 2 (Branching databases)** | **Duration:** 30 min | **Objective:** "By the end, I can test my branching database and fix a question that doesn't work."
...
**Computing · Year 3 · Unit 3 (Multimedia)** | **Duration:** 35 min | **Objective:** "By the end, I can storyboard a short audio/video piece for a purpose and audience."
...
**Prior knowledge to retrieve:** Year 2 — making content for a **purpose and audience**; planning before doing.
...
**Computing · Year 3 · Unit 3 (Multimedia)** | **Duration:** 35 min | **Objective:** "By the end, I can record clear narration and a sound effect for my piece."
...
**Computing · Year 3 · Unit 3 (Multimedia)** | **Duration:** 40 min | **Objective:** "By the end, I can combine images and sound into a short piece and improve one thing."
...
**Revisit later:** end-of-unit check; you'll show this piece again at the Year 3 showcase.
---
...
**Computing · Year 3 · Unit 4 (Researching with reliable sources)** | **Duration:** 30 min | **Objective:** "By the end, I can use who/why/when to judge and rank several sources."
...
**Prior knowledge to retrieve:** Year 2 — "not everything online is true; anyone can publish."
...
**Computing · Year 3 · Unit 4 (Researching with reliable sources)** | **Duration:** 30 min | **Objective:** "By the end, I can tell a fact from an opinion and cross-check a fact in a second source."
...
**Computing · Year 3 · Unit 4 (Researching with reliable sources)** | **Duration:** 35 min | **Objective:** "By the end, I can research a question using sources I've judged reliable and note where facts came from."
...
**Computing · Year 3 · Unit 5 (Staying safe, kind & balanced)** | **Duration:** 25 min | **Objective:** "By the end, I can explain why we keep personal information private and that things shared online can spread."
...
**Revisit later:** deepened as 'digital footprint' in Year 4; bring back at the showcase.
---
...
**Computing · Year 3 · Unit 5 (Staying safe, kind & balanced)** | **Duration:** 25 min | **Objective:** "By the end, I can act kindly online and help when I see unkindness."
...
**Computing · Year 3 · Unit 5 (Staying safe, kind & balanced)** | **Duration:** 25 min | **Objective:** "By the end, I can plan a balanced day and recite the worry plan with my trusted adults."
...
## Lesson 18 — Year 3 computing showcase
**Computing · Year 3 · Unit 5 (Staying safe, kind & balanced)** | **Duration:** 35 min | **Objective:** "By the end, I can demonstrate my loops, data, multimedia and online-smart skills."
**You will need:** all year's resources — a computer with Scratch (loop+pen projects), the branching databases, the saved multimedia pieces, source-ranking cards, worry-plan cards; five station signs; "Year 3 computing expert" certificates.
...
**Process praise:** "You showed *and* explained your skills across the whole year — you've earned 'Year 3 computing expert'."
**Revisit later:** present certificates; carry loops, data and source-skills into Year 4.
---
...
A Year 3 child finishing this curriculum should be able to:
