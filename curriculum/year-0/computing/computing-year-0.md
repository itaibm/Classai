# Computing — Foundation (ages 5–6, KS1) — Lesson Outlines

> Part of **the best international primary school** (see [`../../../SCHOOL-CHARTER.md`](../../../SCHOOL-CHARTER.md)).
> Foundation scope drawn from `knowledge-base/subjects/computing-life-skills/computing-ks1-ks2.md`
> and `online-safety.md`. Follows the lesson-outline format and 8 design principles in
> [`../README.md`](../README.md).

## Year overview

Foundation computing begins **away from the screen**. Before children ever touch a floor robot
...
A Foundation child finishing this curriculum should be able to:
