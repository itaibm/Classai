# Year 3 Music (ages 8–9, KS2) — Lesson Outlines
...
- **Key activity:** Imitate → perform. Learn a 4-beat ostinato (a riff or rhythm) and loop it steadily while the tutor plays a melody on top. Swap roles. Feel two layers = a thicker texture. (Sets up Year 4 part work.)
...
**Listening thread (Unit 4):** One clip per era — a **Baroque/Classical** orchestral piece, a **jazz** standard (e.g. Ellington), a **pop/rock** hit, and an **electronic/dance** track — *notice → feel → judge* and place each in time. (Full history detail → Year 5.)
