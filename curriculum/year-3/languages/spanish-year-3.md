# Spanish — Year 3 (ages 8–9, KS2) — Lesson Outlines

> Part of **the best international primary school** (see [`../../../SCHOOL-CHARTER.md`](../../../SCHOOL-CHARTER.md)).
> This file breaks **Year 3 Spanish** into **20–40 minute lesson outlines**, drawn from
...
Year 3 moves from single words to **short, real sentences**. The big new ideas are *tener* (to
...
How it builds on Year 2: Year 2 gave the sounds, greetings, numbers, colours and noun gender.
Year 3 **uses** them inside sentences — numbers power age and dates, colours now *agree* with the
...
## End-of-year can-do statements (Year 3)
