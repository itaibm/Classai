# Year 3 (ages 8–9) — Year Overview

> Part of **the best international primary school** — see [`../../SCHOOL-CHARTER.md`](../../SCHOOL-CHARTER.md).
> Built to the standard in [`../PLANNING-BRIEF.md`](../PLANNING-BRIEF.md). Year 3 = UK Year 4 / US Grade 3;
> the knowledge-base reference is `knowledge-base/subjects/*/year-4.md` (UK numbering).

## The year in one paragraph

Year 3 is the year children become **fluent, independent readers of whole novels**, **secure in every
times table to 12 × 12**, and **investigators** who ask questions and test them. The number system opens
out to 10,000 and past the decimal point; writing is organised in paragraphs for real readers; science
moves to fair tests every unit; and the humanities travel across three continents — Ancient Greece, the
Roman Empire, the Kingdom of Kush and Ancient China, the Amazon, the Mediterranean and West Africa.
Children begin to *explain* as well as *do*: every lesson ends with a check that asks "why?" or
"show me", not just "what?".

## Subjects, lesson counts and files

| Subject | Lessons | Per week | File | Big ideas this year |
|---|---|---|---|---|
...
| English | 170 | 5 | [`english/english-year-3.md`](./english/english-year-3.md) | class novels *The Iron Man*, *The Boy at the Back of the Class*, *Where the Mountain Meets the Moon*, *The Wild Robot*; Greek myths; *The Arrival*; paragraphs; research reports; explanation texts; playscripts; poetry every term |
...
Built from the §2 budget (22 lessons a week). Times are a guide; keep the order of maths and English
in the morning when attention is highest, and put PE on two non-consecutive days.

| | Mon | Tue | Wed | Thu | Fri |
|---|---|---|---|---|---|
| 08:45–09:00 | Feelings check-in + tables warm-up | Check-in + tables | Check-in + tables | Check-in + tables | Check-in + tables |
| 09:00–09:40 | **English** | **English** | **English** | **English** | **English** |
| 09:40–10:20 | **Maths** | **Maths** | **Maths** | **Maths** | **Maths** |
| 10:20–10:40 | Break | Break | Break | Break | Break |
| 10:40–11:00 | Independent reading (20 min) | Independent reading | Independent reading | Independent reading | Library visit / reading |
| 11:00–11:40 | **Science** | **Spanish** (30) + read-aloud | **Geography** | **Science** | **PE & Health** |
| 11:40–12:20 | **PE & Health** | **History** | **Computing** | **Spanish** (30) + read-aloud | Assembly / class meeting |
| 12:20–13:20 | Lunch & play | Lunch & play | Lunch & play | Lunch & play | Lunch & play |
| 13:20–14:00 | **Life Skills** (35) | **Music** (35) | Outdoor learning / project time | **Art & Design** | Golden time / catch-up |
| 14:00–14:40 | Class novel read-aloud | Singing & recorder practice | Class novel read-aloud | Art (continues when painting or weaving) | Class novel read-aloud |

The Wednesday afternoon and Friday slots give flexibility for fieldwork, science investigations that
run long, art doubles, trips and catch-up — the reason each subject plans ~34–35 teaching weeks inside
a 36-week year.

## How Year 3 connects

- **From Year 2 (ages 7–8):** place value to 1,000 and the 2/3/4/5/8/10 tables; tenths as fractions;
  phonics complete, simple paragraphs and speech marks; Stone Age to Iron Age, Egypt, Sumer and the
  Indus; latitude, hemispheres and rivers; recorder B-A-G; Scratch sequences and events; Spanish
...
- **Kindness and belonging:** *The Boy at the Back of the Class* (English) ↔ upstanders and identity
  (life skills) ↔ online kindness (computing).

## Assessment across the year

Low-stakes and frequent: every lesson has a check for understanding, every unit an end-of-unit mastery
task, and every subject a list of end-of-year mastery checks. Maths and English hold a retrieval and
assessment point at the end of each term; art, music, PE and life skills are assessed by watching,
listening and talking, never by quizzes. A portfolio (September baseline → July) shows each child's growth.
