# Year 3 Art & Design (ages 8–9) — Scope & Sequence
...
35 lessons at 1 a week = 35 weeks. Each unit ends with a 'gallery conversation' in place of a test.

| Term | Unit | Weeks | Lessons | Lessons # |
|---|---|---|---|---|
| T1 | 1. The artist's sketchbook: looking closely | 3 | 3 | 1–3 |
...
## Unit 1 — The artist's sketchbook: looking closely
...
## Unit 2 — Colour theory: the full colour wheel
...
- **Duration:** 40 min
- **Objective:** "By the end, I can use complementary colours side by side to create contrast and energy." (UK NC KS2 Art (colour))
- **Hook:** "Why do red and green, or blue and orange, seem to vibrate when they sit next to each other?"
- **Key activity:** Find complementary pairs opposite each other on the colour wheel; stare at a red dot for 30 seconds then at white paper to see a green after-image. Look at Van Gogh's *Café Terrace at Night* (blue and yellow/orange). Children paint a simple motif (fish, flower, bird) in one colour on a background of its complement, then a second version in harmonious colours, and compare.
- **Check for understanding:** "Put your two paintings side by side. Which one 'pops' more, and why?" → the complementary version — opposite colours make each other look brighter by contrast
- **Differentiation:** support: a colour wheel with complementary pairs linked by arrows / stretch: explain how an artist might use complementary colours to draw your eye to one spot in a painting
- **Materials:** paints, colour wheels, a print of *Café Terrace at Night*
- **Joy:** the after-image 'magic trick'

### Lesson 9 — Digital colour
- **Duration:** 40 min
- **Objective:** "By the end, I can mix and test colour schemes digitally and compare digital and paint colour." (UK NC KS2 Art; links to Computing)
- **Hook:** "On a screen, red and green light make yellow! Paint doesn't. Why?"
- **Key activity:** Use a free drawing app to create a colour-wheel design and try three colour schemes (complementary, harmonious, warm/cool) on the same simple design; notice that screens mix light (RGB), paint mixes pigment.
- **Check for understanding:** "Which colour scheme works best for your design, and why?" → a reasoned choice linked to the mood or effect wanted
- **Differentiation:** support: a pre-made outline to fill / stretch: explain why the same colours can look different on screen and on paper
...
## Unit 3 — Painting with control

**Essential question:** How do painters use brushes, water and layers to control paint?

**Key vocabulary:** brush, flat, round, wash, wet-on-wet, wet-on-dry, blend, layer, opaque, transparent, watercolour, poster paint, background, foreground, still life, composition

### Lesson 10 — Brushes and marks
- **Duration:** 40 min
- **Objective:** "By the end, I can choose the right brush and make controlled marks with paint." (UK NC KS2 Art (painting techniques))
- **Hook:** "A round brush and a flat brush can paint a leaf, a line of grass and a whole sky — if you know how."
- **Key activity:** Brush-mark sampler: dots, dashes, thin lines with the tip, broad strokes with the side, dry-brush texture, stippling. Teach brush care and how much water to use. Children create a sampler and label each mark.
- **Check for understanding:** "Which brush and mark would you use for grass, and which for a sky? Why?" → a thin round brush tip or dry-brush for grass blades; a wide flat brush for a smooth sky wash
- **Differentiation:** support: a sampler grid with the mark pictured in each box / stretch: invent two new marks and use them to paint a texture from nature
- **Materials:** round and flat brushes in several sizes, poster paint, sampler sheets
- **Joy:** "Mark detectives": guess which brush made each mark

### Lesson 11 — Watercolour washes
- **Duration:** 40 min
- **Objective:** "By the end, I can paint flat and graded washes and wet-on-wet effects with watercolour." (UK NC KS2 Art)
- **Hook:** "How does a watercolour sky fade from deep blue to almost white?"
- **Key activity:** Demonstrate a flat wash, a graded wash (more water each stroke) and wet-on-wet blooms; children practise on watercolour paper, then paint a sunset or seascape background.
- **Check for understanding:** "How did you make your wash go from dark to light?" → added more water to the brush with each stroke so the colour became paler
- **Differentiation:** support: smaller paper and a two-colour limit / stretch: combine wet-on-wet and wet-on-dry in one picture and explain the difference
- **Materials:** watercolour sets, watercolour paper, large brushes, sponges
- **Joy:** salt-sprinkle 'starry' texture on wet paint

### Lesson 12 — Cézanne's apples: still life in paint
- **Duration:** 40 min
- **Objective:** "By the end, I can paint a still life by building colour in layers from light to dark." (UK NC KS2 Art (great artists))
- **Hook:** "Cézanne said he wanted to astonish Paris with an apple. How can an apple astonish anyone?"
- **Key activity:** Look at Cézanne's still lifes: patches of colour build the roundness of fruit. Set up a fruit still life; children sketch lightly, block in light colours, then add mid and dark patches of colour to show form.
- **Check for understanding:** "Where did you add darker colour, and how does it make the apple look round?" → on the side away from the light; the change from light to dark makes it look three-dimensional
- **Differentiation:** support: a simpler still life (one or two fruit) / stretch: use complementary colours in the shadows as Cézanne did
...
- **Duration:** 40 min
- **Objective:** "By the end, I can use broken brushstrokes and layered colour to show light on water." (UK NC KS2 Art (great artists))
- **Hook:** "Monet painted the same pond over and over. Why would anyone paint one pond hundreds of times?"
- **Key activity:** Look at Monet's *Water Lilies*: short strokes of colour side by side, light changing through the day. Children paint a pond with a background wash, then dab layered strokes of colour for lilies and reflections.
- **Check for understanding:** "How did you show the reflection in the water?" → repeated the colours of what's above, with broken horizontal strokes
- **Differentiation:** support: a pre-painted background wash / stretch: paint the same scene at two times of day with different colours
- **Materials:** paints, brushes, a Monet water-lily print
- **Joy:** Impressionist 'plein air' painting outdoors if possible

### Lesson 15 — Painting review: gallery conversation
- **Duration:** 40 min
- **Objective:** "By the end, I can evaluate my paintings and explain the techniques I used." (UK NC KS2 Art (evaluate and analyse creative works))
- **Hook:** "Today our classroom becomes a gallery — and you're the curator."
- **Key activity:** Children choose their strongest painting from the unit, write a gallery label (title, technique, artist who inspired it), and discuss it in small groups using talk prompts (What did you try? What worked? What would you change?).
- **Check for understanding:** "Which technique are you proudest of, and what would you do differently next time?" → names a technique (wash, layering, broken strokes) and a specific improvement
- **Differentiation:** support: talk prompts and a label template / stretch: compare your painting with the artist's and explain one similarity and one difference
- **Materials:** paintings, label cards
- **Joy:** gallery walk with 'curator' badges

**End-of-unit check:** Gallery conversation: the child talks about two paintings, naming the techniques used (wash, layering, blending, broken strokes) and the artist who inspired them, and explains one improvement.

---

## Unit 4 — Tone and form: making things look solid
...
- **Materials:** fine-liners, pencils, shoes/bags, Moore prints
- **Joy:** "Line-only" challenge: shade without any smudging

### Lesson 19 — Morandi's bottles: monochrome still life
- **Duration:** 40 min
- **Objective:** "By the end, I can paint a still life in tones of one colour." (UK NC KS2 Art (great artists))
- **Hook:** "Giorgio Morandi painted the same few bottles for years in quiet greys and creams. What makes them so calm?"
- **Key activity:** Look at Morandi's still lifes; arrange bottles and boxes under a lamp; paint in tints and shades of one colour, focusing on light and shadow shapes rather than outlines.
- **Check for understanding:** "How did you use tints and shades to show which side faces the light?" → lighter tints on the lit side, darker shades on the shadow side and cast shadows
- **Differentiation:** support: two or three objects only and a pre-mixed tonal palette / stretch: vary the contrast to make one object the focus
- **Materials:** bottles, boxes, paints, a Morandi print
- **Joy:** "Quiet paintings" gallery

### Lesson 20 — Tone review: gallery conversation
- **Duration:** 40 min
- **Objective:** "By the end, I can evaluate my tonal work and explain how I made forms look solid." (UK NC KS2 Art (evaluate))
- **Hook:** "Can you trick the eye into seeing a flat drawing as 3-D?"
- **Key activity:** Children choose their best tonal work and explain it in a small group using the vocabulary; then shade a mystery object in 10 minutes to show independence.
- **Check for understanding:** "Explain how you made your object look solid, using the words highlight, shadow and cast shadow." → uses all three terms accurately about their own drawing
- **Differentiation:** support: vocabulary cards to point to / stretch: compare two techniques (blending vs hatching) and say which suits which object
- **Materials:** drawings, mystery objects
- **Joy:** "Trick the eye" challenge

**End-of-unit check:** Gallery conversation: the child explains a tonal drawing using highlight, mid-tone, shadow and cast shadow, and compares blending with hatching.
...
- **Duration:** 40 min
- **Objective:** "By the end, I can use overlap, size and placement to show near and far." (UK NC KS2 Art (drawing: depth))
- **Hook:** "Why do distant mountains look small and far-off trees look higher up the page?"
- **Key activity:** Photograph classmates at different distances in the playground; compare sizes; draw a scene with three trees showing overlap, smaller size and higher placement for distance.
- **Check for understanding:** "Point to three clues that tell us which tree is furthest away." → it is smaller, higher up the page and partly hidden behind the nearer trees
- **Differentiation:** support: a template with the horizon and ground drawn / stretch: add a path that narrows as it goes back
...
- **Duration:** 40 min
- **Objective:** "By the end, I can create a layered jungle scene with overlap and repeated leaf shapes." (UK NC KS2 Art (great artists); links to geography)
- **Hook:** "Henri Rousseau painted jungles full of tigers and giant leaves — but he never left France! How?"
- **Key activity:** Look at *Tiger in a Tropical Storm (Surprised!)*: layers of leaves overlapping, darker greens behind, an animal peeping through. Children paint or collage layers from back to front, using tints and shades of green.
- **Check for understanding:** "How did you use layers and different greens to make the jungle look deep?" → painted the back layers first in darker or bluer greens and overlapped brighter leaves in front
- **Differentiation:** support: pre-cut leaf templates for collage / stretch: hide an animal partly behind leaves and explain the effect
- **Materials:** paints, coloured paper, leaf templates, a Rousseau print
- **Joy:** 'hidden animal' guessing game in each other's jungles

### Lesson 30 — Albert Namatjira: colour and distance
- **Duration:** 40 min
...
- **Joy:** paint a landscape from the school window

### Lesson 31 — My landscape: bringing depth together
- **Duration:** 40 min
- **Objective:** "By the end, I can plan and make a landscape that uses at least three depth techniques." (UK NC KS2 Art (create using a range of techniques))
- **Hook:** "Your landscape — real or imagined — must pull the viewer in."
- **Key activity:** Children sketch plans in sketchbooks (thumbnails), choose their best, then paint or collage it using overlap, size, placement and colour for distance; peer feedback half-way.
- **Check for understanding:** "Which three depth techniques did you use, and where?" → names and points to three techniques in their work
- **Differentiation:** support: checklist of techniques / stretch: explain how an artist from this unit influenced your choices
...
## Unit 7 — Year 3 exhibition

**Essential question:** How do artists choose, present and talk about their best work?

**Key vocabulary:** exhibition, curate, select, label, artist's statement, portfolio, feedback, gallery, audience

### Lesson 32 — Reviewing my sketchbook
- **Duration:** 40 min
- **Objective:** "By the end, I can review my sketchbook and choose pieces that show my progress." (UK NC KS2 Art (review and revisit ideas))
- **Hook:** "Your sketchbook is a record of a year of looking. What does it show?"
- **Key activity:** Children page through their sketchbook with a partner, tag pieces showing progress in drawing, colour, painting, tone, textiles and depth, and choose three for the exhibition.
- **Check for understanding:** "Which piece shows your biggest progress, and what can you do now that you couldn't in September?" → names a piece and a specific skill gained
- **Differentiation:** support: a progress checklist with pictures / stretch: explain how one experiment in the sketchbook led to a finished piece
- **Materials:** sketchbooks, sticky tabs
- **Joy:** 'then and now' pairing

### Lesson 33 — Writing artist's statements
- **Duration:** 40 min
- **Objective:** "By the end, I can write a short artist's statement about my chosen work." (UK NC KS2 Art; links to English)
- **Hook:** "Real galleries have labels. What should yours say?"
- **Key activity:** Read example gallery labels; write statements naming the technique, inspiration and intention.
- **Check for understanding:** "What does your statement tell a visitor that the picture alone doesn't?" → the techniques, the artist who inspired it and the idea behind it
- **Differentiation:** support: statement frame / stretch: include what you'd do next
- **Materials:** label cards
- **Joy:** label-writing like a real museum
...
- **Duration:** 40 min
- **Objective:** "By the end, I can talk about my art to visitors and respond to questions." (UK NC KS2 Art (evaluate and discuss))
- **Hook:** "The doors are open!"
- **Key activity:** Children act as guides to their work for families and other classes; visitors leave comments.
- **Check for understanding:** "What question did a visitor ask, and how did you answer?" → recalls question and gives an answer about technique or inspiration
- **Differentiation:** support: talk prompts / stretch: lead a mini-tour
- **Materials:** exhibition, comment cards
- **Joy:** opening event

**End-of-unit check:** Exhibition conversation: the child explains three pieces of their work to a visitor, naming techniques and artists and describing their progress.
...
**Talk, don't test.** Every lesson ends with conversation about the work: "What did you try? What worked? What would you change? Which artist helped you?" Record short notes or photos of the sketchbook rather than marks.

**Common misconceptions to watch for.**
- *Sketchbooks must be neat* — they are for experimenting; crossing out and trying again is good practice.
- *Adding black is the only way to darken* — try the complementary colour for richer shades.
