# Year 4 Geography (ages 9–10, KS2) — Lesson Outlines

> Part of **the best international primary school** (see [`../../../SCHOOL-CHARTER.md`](../../../SCHOOL-CHARTER.md)).
> Year 4 continues the KS2 geography journey, drawn from
...
Year 4 geography deepens into the most powerful **physical processes** — **mountains, volcanoes and earthquakes** and the tectonic plates that drive them — and into **human geography**, with **settlements and land use** building on Year 2's settlement hierarchy. The tectonics unit explains the very mountains and coasts that shaped where people could settle; the settlements unit reads land use from real maps and traces how a village grows into a city. Disciplinary questions deepen to **"how do we know?"**, **"why here?"**, and **"is this fair and reliable?"**. Two units, 6 lessons.

---

## Unit 1 — The Restless Earth: mountains, volcanoes & earthquakes
...
### Lesson 1 — The cracked shell: tectonic plates
- **Duration:** 40 min
...
### Lesson 3 — Volcanoes: magma to lava
- **Duration:** 40 min
...
### Lesson 4 — Earthquakes and the Ring of Fire
- **Duration:** 40 min
...
### Lesson 5 — Land use: what land is *for*
- **Duration:** 40 min
...
- **Key activity:** Build on Year 2's settlement hierarchy and site factors. Introduce **land use**: **residential** (homes), **commercial** (shops/offices), **industrial** (factories/warehouses), **agricultural** (farms), **recreational** (parks/sports). Categorize land-use photos. Note land has *many* uses, not just "town vs countryside."
...
### Lesson 6 — Reading land use from a map
- **Duration:** 40 min
...
### Lesson 7 — Why settlements grow at good sites (revisited & deepened)
- **Duration:** 35 min
...
**End-of-unit check (Unit 2):** Name the five land-use types with examples; read land use from a map; explain why settlements grow at good sites and how land use changes. **Misconception watch:** a city differs from a town in size *and* services; settlements grew for reasons; land has many uses, often mixed.

---

## End-of-year mastery checks (Geography)

A Year 4 child who has mastered this year's geography should be able to:

1. **(Tectonics — plates)** Explain what tectonic plates are and how mountains form.
2. **(Tectonics — volcanoes)** Explain the difference between magma and lava and how a volcano forms.
3. **(Tectonics — earthquakes)** Explain what causes earthquakes and why mountains, volcanoes and earthquakes cluster at plate boundaries.
4. **(Land use)** Name the five land-use types with examples and read land use from a map.
5. **(Settlements)** Explain why settlements grow at good sites and how their land use changes as they grow.
6. **(Cross-strand)** Use the world map to relate Viking voyages across the oceans and the physical landscapes that shaped where people settled.
