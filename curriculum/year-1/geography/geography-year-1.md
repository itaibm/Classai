# Year 1 Geography (ages 6–7, KS1) — Lesson Outlines

> Part of **the best international primary school** (see [`../../../SCHOOL-CHARTER.md`](../../../SCHOOL-CHARTER.md)).
> Year 1 completes the KS1 Geography strand, drawn from
> [`knowledge-base/subjects/history-geography/geography-ks1.md`](../../../knowledge-base/subjects/history-geography/geography-ks1.md).

## Year overview

Foundation built the first geography — bird's-eye maps, the compass, the UK, the globe, hot/cold places and the seasons. **Year 1 consolidates the KS1 skills before KS2's big jump into systems.** We sharpen **map and fieldwork** skills (plan views, scale/shrinking, giving and following routes), then **compare the UK with a contrasting hot place**, pinning every fact to the **wall map and globe**. The work keeps "place" thinking alive and builds the fair-minded habit that places are different *and* alike — never "better or worse." Two units, 6 lessons.

---

## Unit 1 — Mapmaker Skills: revisiting maps, symbols and the compass
...
## Unit 2 — Comparing Places: my hometown and a hot, faraway place
...
KS2 begins next year with the global grid and deeper UK geography:
- **The global grid** — **latitude, longitude, hemispheres and time zones** — so the learner can pinpoint any place on Earth.
- **UK regions, settlements and physical/human geography** in more depth, building on KS1's countries-and-capitals.
- **Rivers** as physical geography, linking place to the river civilisations studied in history.
...
1. **(Map skills)** Draw a bird's-eye plan with a key, explain that a map is shrunk, and give or follow a compass route (N/E/S/W).
2. **(Plan view)** Draw a simple plan of objects on a table and explain it shows the view from straight above.
...
5. **(Comparison)** Give two similarities and two differences between a contrasting hot place and their hometown.
