# Art & Design — Year 1 (ages 6–7, KS1) — Lesson Outlines

> Part of **the best international primary school** (see [`../../../SCHOOL-CHARTER.md`](../../../SCHOOL-CHARTER.md)).
> Year 1 scope drawn from [`knowledge-base/subjects/art-music/art-ks1-ks2.md`](../../../knowledge-base/subjects/art-music/art-ks1-ks2.md)
...
Year 1 **consolidates and stretches** the Foundation toolkit. Where Foundation met each formal element once, Year 1
asks the child to **combine and control** them with more intention. The spine: we restart the **sketchbook** as
a deliberate working habit (date it, test in it, never "spoil" it); we push **colour** past Foundation's tints into
...
lesson, Year 1 dwells longer on **Henri Matisse** (his cut-outs across a whole unit) and revisits **Van Gogh**,
...
> **Builds on Foundation, hands to Year 2.** Foundation's lines, primary/secondary colour, warm/cool and first prints
> are assumed. **Observational drawing and tone/shading** (KB topics 7 & 10) begin properly in Year 2 — Year 1
...
> **Continues into Year 2:** drawing real objects in front of you (observational drawing, KB topic 7) starts in Year 2.
...
- **Key activity:** Recap tints from Foundation → the child paints a 5-step ladder of one colour, adding a little more white each step, keeping each box even.
...
> **Continues into Year 3:** the full colour wheel with complementary colours and harmonies (KB topic 2) deepens in Year 3.
...
> **Continues into Year 4:** collage as part of larger mixed-media and printmaking projects deepens in Year 4.
...
> **Continues into Year 4:** carved-block relief printmaking (polystyrene/lino-style) and multi-layer prints (KB topic 4) develop in Year 4.
...
> **Continues into Year 4:** larger sculpture, armatures and modelling depth (KB topic 6) develop in Year 4.
...
By the end of Year 1, a child's sketchbook/portfolio should show:
